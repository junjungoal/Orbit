...
class RandomizationCfg:
    ...
    class GoalPoseCfg:
        ...
        position_uniform_min = [0.6, -0.1, 0.]  # position (x,y,z)
        position_uniform_max = [0.65, 0.1, 0.]  # position (x,y,z)
...
class RewardsCfg:
    ...
    tracking_object_position_tanh = {"weight": 1, "sigma": 0.05, "threshold": 0.08}
    push_object_success = {"weight": 2, "threshold": 0.04}
...
class PushEnvCfg(IsaacEnvCfg):
    ...
    # General Settings
    env: EnvCfg = EnvCfg(num_envs=4096, env_spacing=5, episode_length_s=2.0)
