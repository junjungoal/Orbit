...
@configclass
class TargetManipulationObjectCfg(RigidObjectCfg):
    """Properties for the object to manipulate in the scene."""
...
class RewardsCfg:
    ...
    aligning_objects = {"weight": 2.5, "threshold": 0.11, "sigma": 5.}
    stack_success = {"weight": 4.}
...
class StackEnvCfg(IsaacEnvCfg):
    ...
    target_object: ManipulationObjectCfg = TargetManipulationObjectCfg()
    # -- table
