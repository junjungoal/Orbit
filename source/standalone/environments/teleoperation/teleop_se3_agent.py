...
def main():
    ...
    # create environment
    env = gym.make(args_cli.task, cfg=env_cfg, headless=args_cli.headless, enable_camera=False, enable_render=True)
    ...
    if args_cli.device.lower() == "keyboard":
        teleop_interface = Se3Keyboard(
            pos_sensitivity=0.3 * args_cli.sensitivity, rot_sensitivity=0.2 * args_cli.sensitivity
        )
